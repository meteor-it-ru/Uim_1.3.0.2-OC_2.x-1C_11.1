...
class ControllerExtensionExchange1c extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->get['install']) && $this->request->get['install']) {
			...
			$this->install();
			$this->response->redirect($this->url->link('extension/exchange_1c', 'token=' . $this->session->data['token'], 'SSL'));
		}
		...
		$data['action'] = $this->url->link('extension/exchange_1c', 'token=' . $this->session->data['token'], 'SSL');

		$data['install'] = $this->url->link('extension/exchange_1c', 'install=1&token=' . $this->session->data['token'], 'SSL');
		$data['uninstall'] = $this->url->link('extension/exchange_1c', 'uninstall=1&token=' . $this->session->data['token'], 'SSL');
		...
		$this->response->setOutput($this->load->view('extension/exchange_1c.tpl', $data));
	}
